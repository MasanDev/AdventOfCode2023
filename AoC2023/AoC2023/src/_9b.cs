...
namespace AoC2023.src
{
    public class _9b
    {
        ...
        public string GetNextValueInSequence(List<string> RowInput)
        {
            ...
            {
                return (Int32.Parse(RowInput.First()) - Int32.Parse(tempLine.First())).ToString();
            }
            return (Int32.Parse(RowInput.First()) - Int32.Parse(GetNextValueInSequence(tempLine))).ToString();
